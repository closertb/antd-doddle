...
export default function ImageLoad(props) {
  ...
  }, !waiting && /*#__PURE__*/React.createElement(Loading, null)), /*#__PURE__*/React.createElement(CSSTransition, {
    "in": isReady,
    timeout: transtionTime,
    classNames: transtionClassName,
    unmountOnExit: true
  }, children || /*#__PURE__*/React.createElement("img", Object.assign({}, imgProps))));
}