...
export default function FormRender(props: UninProps, rightProps?: FormRenderProps) {
    let secStepProps;
    let firstStepProps;
    ...
    const { field, data = {}, wrapProps = {} } = secStepProps;

    const { require, getFieldDecorator, formItemLayout, containerName, withWrap: defaultWrap, Wrapper } = firstStepProps;
