...
export default class HModal extends React.PureComponent {
    constructor(props) {
        super(props);
        const { visible } = props;
        this.state = {
    ...
    render() {
        ...
        const modalProps = Object.assign({}, this.props, { confirmLoading, visible: true, onOk: this.handleOk, onCancel: this.handleCancel });
