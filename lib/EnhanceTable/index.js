...
var EnhanceTable = /*#__PURE__*/function (_React$PureComponent) {
  _inherits(EnhanceTable, _React$PureComponent);

  var _super = _createSuper(EnhanceTable);
  ...
  _createClass(EnhanceTable, [{
    ...
    value: function render() {
      var _a = this.props,
          ...
          others = __rest(_a, ["fields", "search", "datas", "total", "loading", "onSearch", "rowKey", "footer", "pagination", "pageName"]);

      var columns = this.getInitalColumns(fields); // pagination 默认由组件自身生成，设置为 null 时不渲染，设置为object 时为自定义

      var _pagination = pagination && (_typeof(pagination) === 'object' ? pagination : {
        total: total,
        current: search[pageName],
        pageSize: search[_common.Pagination.PS],
        onChange: function onChange(pn) {
          return onSearch(_defineProperty({}, pageName, pn));
        },
