...
exports.Rules = exports.Type = exports.throttle = exports.toFormatEnums = exports.getValueFromEnums = exports.getEnumObject = exports.isEmpty = exports.formItemLayout = exports.DATE_TIME_FORMAT = exports.DATE_FORMAT = void 0;
...
function idCodeValid(code, mask) {
  ...
  if (!code || !/^\d{6}(18|19|20)\d{2}(0[1-9]|1[012])(0[1-9]|[12]\d|3[01])\d{3}(\d|X)$/i.test(code)) {
    ...
    checkBool = false;
  } else if ((0, _dayjs["default"])("".concat(code.substring(6, 10), "-").concat(code.substring(10, 12), "-").concat(code.substring(12, 14))).isBefore((0, _dayjs["default"])())) {
    checkBool = false;
  } else {
...
function getAgeById() {
  ...
  if (idCodeValid(id)) {
    var birth = (0, _dayjs["default"])("".concat(id.substring(6, 10), "-").concat(id.substring(10, 12), "-").concat(id.substring(12, 14)));
