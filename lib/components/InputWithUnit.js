...
function (_React$Component) {
  ...
  _createClass(InputWithUnit, [{
    ...
    value: function render() {
      ...
      var time = this.state;
      return _react.default.createElement("span", null, _react.default.createElement(_antd.Input, _extends({
        value: time.number,
        ...
        placeholder: "\u8BF7\u8F93\u5165"
      }, inputProps)), _react.default.createElement(_antd.Select, _extends({
        value: time.unit,
        style: {
          width: '32%'
        },
