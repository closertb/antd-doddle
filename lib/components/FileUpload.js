...
function (_React$Component) {
  ...
  function FileUpload(props) {
    ...
    _defineProperty(_assertThisInitialized(_assertThisInitialized(_this)), "customRequest", function (option) {
    ...
    _defineProperty(_assertThisInitialized(_assertThisInitialized(_this)), "handleSimplePreview", function (url) {
      return function () {
        _this.setState({
          imageUrl: url,
          previewVisible: true
  ...
  _createClass(FileUpload, [{
    ...
    value: function render() {
      ...
      return _react.default.createElement("div", {
        className: _index.default.ImageUpload
      }, _react.default.createElement("div", {
