...
function _default(_ref) {
  var _ref$formItemLayout = _ref.formItemLayout,
      formItemLayout = _ref$formItemLayout === void 0 ? _index.formItemLayout : _ref$formItemLayout,
  ...
  return function FormRender(props) {
    ...
    switch (type) {
      ...
      case 'origin':
        ...
        })(_react.default.createElement(_OriginSearch.default, _extends({
          disabled: disable && disable(data),
          style: {
            width: '100%',
            height: 32
      ...
      case 'datePicker':
        content = isUndefind(props.isEnable, isEnable) && _react.default.createElement(FormItem, _extends({
          ...
          format: format || _index.DATE_FORMAT,
          onChange: props.onChange || onChange,
      ...
      case 'rangePicker':
        ...
        content = isUndefind(props.isEnable, isEnable) && _react.default.createElement(FormItem, _extends({
          ...
          onChange: props.onChange || onChange,
          format: format || (showTime ? _index.DATE_TIME_FORMAT : _index.DATE_FORMAT),
      ...
      case 'imageUpload':
        ...
        })(_react.default.createElement(_FileUpload.default, _extends({
          info: field.info,
          url: props.url,
          name: name,
