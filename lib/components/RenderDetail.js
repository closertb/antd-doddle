...
function renderBaseFields(fields) {
  ...
  return fields.map(function (_ref, index) {
    ...
    if (type === 'date') {
      value = value && (0, _moment.default)(value).format(_index.DATE_FORMAT);
    }

    if (type === 'datetime') {
      value = value && (0, _moment.default)(value).format(_index.DATE_TIME_FORMAT);
      !value && (value = '-:-:-');
    } // 处理枚举


    if (enums && enums.length > 0) {
      value = (0, _index.getEnumObject)(enums, props[key]).label;
    } // 处理render 函数
