...
function FormRender(props) {
  ...
  if (_renderType["default"][type]) {
    ...
    content = shouldUpdate ? _react["default"].createElement(FormItem, {
      ...
      return finalEnable(initData, datas) ? _react["default"].createElement(FormItem, Object.assign({
        key: key,
        name: key,
        label: name,
    ...
    }) : _react["default"].createElement(FormItem, Object.assign({
      key: key,
      name: key,
      label: name,
      dependencies: dependencies,
