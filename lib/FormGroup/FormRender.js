...
function FormRender(props) {
  ...
  if (_renderType["default"][type]) {
    ...
    content = shouldUpdate ? /*#__PURE__*/_react["default"].createElement(FormItem, {
      ...
      return finalEnable(initData, datas) ? /*#__PURE__*/_react["default"].createElement(FormItem, Object.assign({
        key: key,
        name: key,
        label: name,
    ...
    }) : /*#__PURE__*/_react["default"].createElement(FormItem, Object.assign({
      key: key,
      name: key,
      label: name,
      dependencies: dependencies,
  ...
  return isUndefind(props.withWrap, isUndefind(withWrap, defaultWrap)) ? /*#__PURE__*/_react["default"].createElement(Wrapper, Object.assign({}, wrapProps), content) : content;
}
