  ...
  _createClass(DynamicForm, [{
    ...
    value: function render() {
      ...
      return _react["default"].createElement("div", {
        ...
        return _react["default"].createElement("div", {
          key: rule.key
        }, children(rule, dataBind), !rule.disableBtn && index > 0 && _react["default"].createElement(_icons.MinusCircleOutlined, {
          className: "self-style",
          onClick: function onClick() {
            return _this2.handlMinus(rule.key);
          }
        }), !rule.disableBtn && index === 0 && _react["default"].createElement(_icons.PlusCircleOutlined, {
          className: "self-style",
          onClick: _this2.handlAdd
        }), !rule.disableBtn && canMove && index > 0 && _react["default"].createElement(_icons.UpCircleOutlined, {
          className: "self-style",
          onClick: _this2.handlMoveUp(rule.key)
        }), !rule.disableBtn && canMove && index < length && _react["default"].createElement(_icons.DownCircleOutlined, {
          className: "self-style",
