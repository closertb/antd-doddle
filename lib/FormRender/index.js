  ...
  return function FormRender(props) {
    ...
    switch (type) {
      ...
      case 'input':
        ...
        content = _react["default"].createElement(FormItem, _extends({
          key: specialKey || key,
          label: name
        }, formItemLayout, {
    ...
    var domNode = isUndefind(props.withWrap, isUndefind(withWrap, defaultWrap)) ? _react["default"].createElement(Wrapper, wrapProps, content) : content;
