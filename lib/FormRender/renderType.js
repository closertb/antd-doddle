...
var OriginInput = function OriginInput(_ref) {
  ...
  return _react["default"].createElement(_OriginSearch["default"], _extends({
...
var UploadFile = function UploadFile(_ref2) {
  ...
  return _react["default"].createElement(_FileUpload["default"], _extends({
    info: field.info,
    url: props.url,
    name: name,
...
var WithUnit = function WithUnit(_ref3) {
  ...
  var inputProps = field.inputProps,
      ...
      enums = field.enums,
      seldomProps = field.seldomProps;
  return _react["default"].createElement(_InputWithUnit["default"], _extends({
    enums: enums,
