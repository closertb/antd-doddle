...
function warning(condition, message) {
  if (!condition) {
    (0, _invariant["default"])(condition, "[Furion]: ".concat(message));
  }
}
/**
...
var memoizedGetEffectsForActions = (0, _memoizeOne["default"])(getEffectsForActions);
var memoizedGetConnectState = (0, _memoizeOne["default"])(getConnectState);
var memoizedGetAppModelEffects = (0, _memoizeOne["default"])(getAppModelEffects);
...
function model(namespace) {
  ...
  return function connected(WrapperComponent) {
    var HOC = /*#__PURE__*/function (_WrapperComponent) {
