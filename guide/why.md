...
关于antd-doddle是什么，前面已经介绍过了，这里介绍一下antd-doddle的产生带来的意义。主要解决通用表单，列表，详情的写法，真正做到用数据（field）去驱动试图，下面一个常用的搜索框，感受一下
...
对比一下，代码量是不是减少了好多，要添加减少搜索量，我们只需要去维护field。更多方便，请看组件介绍及示例。